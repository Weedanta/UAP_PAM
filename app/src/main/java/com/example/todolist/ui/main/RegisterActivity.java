...
public class RegisterActivity extends AppCompatActivity {
                ...
                if (result.getResultCode() == RESULT_OK) {
                    authManager.handleGoogleSignInResult(result.getData(), new FirebaseAuthManager.AuthCallback() {
                        ...
                        public void onSuccess(FirebaseUser user) {
                            hideLoading();
                            Toast.makeText(RegisterActivity.this, "Registration successful! Welcome " + user.getDisplayName(), Toast.LENGTH_SHORT).show();
                            startMainActivity();
                        }
    ...
    private void setupUI() {
        // Change button text for registration
        binding.btnGoogleSignIn.setText("Sign up with Google");
